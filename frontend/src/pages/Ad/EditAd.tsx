...
const EditAd = () => {
    ...
    // Wczytaj dane ogłoszenia do formularza
    useEffect(() => {
    ...
    const onSubmit = async (data: AdsAddSchema) => {
        ...
        try {
            const response = await axios.put(`http://localhost:3000/ads/${id}`, completeData, {
            ...
            <div className="w-full min-h-screen flex flex-col bg-gray-50">
                ...
                <div className="flex-1 flex items-center justify-center">
                    <div className="text-center">
                        ...
                        <h2 className="text-2xl font-bold text-red-500 mb-2">Nie znaleziono ogłoszenia</h2>
                        <p className="text-gray-600 mb-4">Ogłoszenie nie istnieje lub nie masz uprawnień do jego edycji.</p>
                        <Button 
                            type="button" 
                            style="primary" 
            ...
            {submitSuccess ? (
                <div className="flex-1 flex items-center justify-center flex-col p-8">
                    <div className="bg-white p-8 rounded-lg shadow-md max-w-md w-full text-center">
                        ...
                        <h2 className="text-2xl font-bold text-gray-800 mb-2">Ogłoszenie zaktualizowane!</h2>
                        <p className="text-gray-600 mb-6">Twoje ogłoszenie zostało pomyślnie zaktualizowane.</p>
                        <p className="text-gray-500 text-sm">Za chwilę zostaniesz przekierowany do Twoich ogłoszeń...</p>
                    </div>
                </div>
            ) : (
